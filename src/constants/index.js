...
const projects = [
  {
    name: 'Nextjs  Dashborad',
    description: 'Responsive Next.js dashboard built with ShadCN components, offering an intuitive and interactive interface for managing data and monitoring metrics efficiently.',
    tags: [
      {
        name: 'nextjs',
    ...
    image: NextjDashborad,
    source_code_link: 'https://github.com/Amirrezakrym/nextjs-dashboard',
  },
  {
    name: 'Job IT',
